...
#**************Aqui es la función donde realiza el match***************
def  hacerrecomendacion(gen,respaginas, costo2):
    ...
    while x:  #Para que el usuario pueda elegir un ambiente y si se equivoca vuelve a preguntar
        #aqui buscamos dentro de la base todos los nodos que cumplen con costo, paginas y genero
        ...
        #Se agregan todos los nodos de libros y se imprimen sus titulos 
        for i in results:
            print("-"+"%s"%(i[0]["titulo"]))
        x = False
